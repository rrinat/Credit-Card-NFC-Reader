package com.pro100svitlo.creditCardNfcReader.bitlib;
...
public final class BitUtils {
     ...
     */
    private static final String LOGGER_TAG = BitUtils.class.getSimpleName();
    /**
    ...
    public Date getNextDate(final int pSize, final String pPattern, final boolean pUseBcd) {
        ...
        try {
            ...
            Log.e(LOGGER_TAG, "Parsing date error. date:" + dateTxt + " pattern:" + pPattern, e);
        }
        return date;
    }
